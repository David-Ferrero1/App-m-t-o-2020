...
const CLEAPI = '19c2dc960ab727a65d068f9f8aa4aa2e'
let resultatsAPI;
...
if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(position =>{
        ...
        alert(`Vous avez refusé la géoloc, l'appli ne peut pas fonctionner sans, veullez l'activer`)
    })
}
